import { useWalletKit } from "@gokiprotocol/walletkit/src/WalletKitProvider";
...
export const DisconnectWalletButton: React.FC<Props> = ({
  ...
  return (
    <Button variant={variant} {...buttonProps} onClick={disconnect}>
      <span>{shortenString(wallet ? wallet.publicKey.toString() : "", 8)}</span>
      <span>
